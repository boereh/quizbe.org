...
export const useSelectVariant = tv({
	slots: {
		...
		item: 'cursor-pointer flex items-center transition font-medium hover:(bg-zinc-200)',
	},
	variants: {
		size: {
			xs: {
